...
<div class="jumbotron mx-5">       
    ...
    <div class="row justify-content-center border border-primary rounded">                    
                <div class="col-12 form-group text-center">
                    <br>
                    <h2>Esta seguro en de dar de baja el prestamo: <br> <?php echo $id; ?></h2>   
                </div>
                <div class="input-group justify-content-center">
                    <button type="button" class="input-item btn btn-danger" onclick="location.href='/nomitec/backend/empleados/prestamos/bajas.php?id=<?php echo $id ?>'">Si, estoy de acuerdo </button>   
                    <button type="button" class="input-item btn btn-warning" onclick="location.href='/nomitec/views/empleados/prestamos/prestamos.php'">No, regresar al listado </button>   
                </div> 
                <br>
    </div>               
</div>
