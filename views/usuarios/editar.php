                ...
                <div class="row justify-content-center">                    
                    <div class="col-6 form-group">                                            
                        <div class="form-group">
                            <label>User</label>
                            <input type="text" name="user" class="form-control text-center" value="<?php echo $obj["user"]; ?>">
                        </div>
                        <div class="form-group">
                            <label>Contrasena</label>
                            <input type="password" name="pass" class="form-control text-center" value="<?php echo $obj["pass"]; ?>">
                        </div>
                        <div class="form-group">
