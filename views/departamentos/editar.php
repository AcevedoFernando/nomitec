...
<body>
    ...
    <div class="jumbotron mx-5">
            ...
            <div class="row justify-content-center"><h3 class="font-text-bold">Departamento:<?php echo " ".$name ?> </h3></div>      
            <hr>
            <div class="row justify-content-center">
                <h5><em>Cambio de jefe</em></h5>  
            </div>           
            <div class="row justify-content-center">                        
                 <form action="/nomitec/backend/departamentos/editar.php?id_dep=<?php echo $id; ?>" method="post">                                          
