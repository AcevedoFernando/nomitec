...
<body>
    ...
    <div class="jumbotron mx-5">
            ...
            <div class="row justify-content-center"><h3 class="font-text-bold">Registro de departamento</h3></div>      
            <hr>
            <div class="row justify-content-center">                                
                <form action="/nomitec/backend/departamentos/altas.php" method="post">
                    <div class="col form-group text-center">
                    <h5><em>Datos del departamento</em></h5>
                        <input type="text" name="nombre" placeholder="Nombre" class="form-control" required>

                        <br>
                    <div class="col form-group">                                          
                        <div class="form-group">
                            <label for="id_empleado">Jefe del departamento</label>                             
                        ...
                        <br>                                                                                 <button type="submit" class="btn btn-success form-control">Registrar</button>
                    </div>                                
                    </div>
